        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('auth.login.process') }}" style="margin-top: 20px">
                        {{ csrf_field() }}
                ...
                <div class="panel-footer">
                    ...
                    <i class="fa fa-copyright"></i> 2018 All Rights Reserved | <a href="http://www.kangkoding.com">kangkoding.com</a>
                    </div>
                </div>
            </div>
        </div>
